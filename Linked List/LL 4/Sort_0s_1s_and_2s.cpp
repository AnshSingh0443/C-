...
//approach 1->keep count of 0s 1s and 2s then while iterating through the LL overwrite the data with 0s,1s and 2s acc to their count
...
//approach 2(no data replacing)->we make 3 dummy LL for  0s ,1s and 2s then based on which one is null or not we join the three LL in a sorted manner
